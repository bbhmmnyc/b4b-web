    ...
    >
      ...
      >
        ...
        <div className="p-5 flex flex-col flex-1">
          ...
          {/* Excerpt */}
          <p className="text-sm leading-relaxed mb-4 line-clamp-2 flex-1" style={{ color: '#10253A' }}>
            {post.excerpt}
          </p>
          ...
          <div className="flex items-center gap-2.5 mb-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-1 text-[10px]" style={{ color: '#26384A' }}>
          ...
          >
            <div className="flex items-center gap-3 text-[10px]" style={{ color: '#26384A' }}>
